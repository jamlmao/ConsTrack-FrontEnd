...
@Component({
  ...
  standalone: true,
  imports: [MatListModule, MatSidenavModule, MatIconModule, MatButtonModule, RouterLink, RouterLinkActive, MatToolbarModule, RouterModule, RouterOutlet, HeaderComponent, SidenavComponent, CreateStaffAcctComponent, CreateClientAcctComponent],
