...
@Component({
  ...
  templateUrl: './plastering.component.html',
  styleUrl: './plastering.component.css'
})
export class PlasteringComponent {
  tasks: any[] = [];
  searchText:any;
  user: any;
  ...
  private taskUrl = 'http://127.0.0.1:8000/api/tasks/plaster';
