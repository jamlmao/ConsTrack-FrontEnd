...
@Component({
  ...
  templateUrl: './concreteworks.component.html',
  styleUrl: './concreteworks.component.css'
})
export class ConcreteworksComponent {
  tasks: any[] = [];
  searchText:any;
  user: any;
  ...
  private taskUrl = 'http://127.0.0.1:8000/api/tasks/concrete';
