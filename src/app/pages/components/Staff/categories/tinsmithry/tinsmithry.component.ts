...
@Component({
  ...
  templateUrl: './tinsmithry.component.html',
  styleUrl: './tinsmithry.component.css'
})
export class TinsmithryComponent {
  tasks: any[] = [];
  searchText:any;
  user: any;
  ...
  private taskUrl = 'http://127.0.0.1:8000/api/tasks/tins';
