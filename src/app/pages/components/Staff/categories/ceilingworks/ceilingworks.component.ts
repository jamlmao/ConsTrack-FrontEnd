...
@Component({
  selector: 'app-ceilingworks',
  standalone: true,
  imports: [FilterPipe, MatListModule, MatSidenavModule, MatIconModule, RouterLink, RouterLinkActive, MatButtonModule, MatToolbarModule, RouterModule, RouterOutlet, CommonModule, HttpClientModule, FormsModule, FontAwesomeModule, CreateClientAcctComponent, CreateProjectComponent, ArchiComponent, StafftoolbarComponent, StaffsidenavComponent],
  templateUrl: './ceilingworks.component.html',
  styleUrl: './ceilingworks.component.css'
})
export class CeilingworksComponent {
  tasks: any[] = [];
  searchText:any;
  user: any;
  ...
  private taskUrl = 'http://127.0.0.1:8000/api/tasks/ceiling';
