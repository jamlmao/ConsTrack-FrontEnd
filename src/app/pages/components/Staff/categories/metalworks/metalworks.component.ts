...
@Component({
  ...
  templateUrl: './metalworks.component.html',
  styleUrl: './metalworks.component.css'
})
export class MetalworksComponent {
  tasks: any[] = [];
  searchText:any;
  user: any;
  ...
  private taskUrl = 'http://127.0.0.1:8000/api/tasks/metal';
